...
\begin{entrylist}
  ...
  {07/18 - Present}
  {Software Developer }
  {Substrakt, Birmingham UK}
  {Backed PHP and Javascript engineer
  Working on internal WordPress tooling and plugins.
  Requirements gathering for client projects.
  Leasing with the design team to implement features into the CMS for each bespoke client website.
  Upgrading our JavaScript stack from gulp to webpack to make use of more modern tooling and processes.
  \\}
